        ...
        <div className="grid grid-cols-2 gap-16 items-center lg:mx-auto">
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-400 text-center">
              {" "}
              Siempre en búsqueda de aprender más y aportar soluciones.
            </p>
          </div>
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-400 text-center">
              {" "}
              Listo para enfrentar proyectos que me permitan crecer.
            </p>
          </div>
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-400 text-center">
              {" "}
              He desarrollado proyectos individuales y grupales.
            </p>
          </div>
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-400 text-center">
              {" "}
              Busco colaborar en proyectos desafiantes e innovadores
            </p>
          </div>
        </div>
      </div>

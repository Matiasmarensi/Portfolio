    ...
    <div className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-rose-800 overflow-hidden relative">
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          {/* text */}
          <div>
            <h1 className="text-2xl md:text-3xl font-bold mb-5">I am {BaseInfo.name}</h1>
          ...
          {/* image */}
          <div className="mx-auto hidden lg:block rounded-[3rem] border-[3.5px] border-blue-900 overflow-x-hidden">
